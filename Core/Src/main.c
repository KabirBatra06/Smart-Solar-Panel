...
struct triple *initL0()
{
    static struct triple data[64] = {
        {175347046, 0, 0},
...
struct triple *initL1()
{
    static struct triple data[34] = {
        {628331966747, 0, 0},
...
struct triple *initL2()
{
    static struct triple data[20] = {
        {52919, 0, 0},
...
struct triple *initL3()
{
    static struct triple data[7] = {
        {289, 5.844, 6283.076},
        {35, 0, 0},
        {17, 5.49, 12566.15},
        {3, 5.2, 155.42},
...
struct triple *initL4()
{
    static struct triple data[3] = {
        {114, 3.142, 0},
        {8, 4.13, 6283.08},
        {1, 3.84, 12566.15}
    };
...
struct triple *initL5()
{
    static struct triple data[1] = {
        {1, 3.14, 0}
    };
...
double getL0(struct triple *data, double julianEphemerisMillenium)
{
    double L0 = 0;
    for (int i = 0; i < 64; i++)
    {
...
double getL1(struct triple *data, double julianEphemerisMillenium)
{
    double L1 = 0;
    for (int i = 0; i < 34; i++)
    {
...
double getL2(struct triple *data, double julianEphemerisMillenium)
{
    double L2 = 0;
    for (int i = 0; i < 20; i++)
    {
...
double getL3(struct triple *data, double julianEphemerisMillenium)
{
    double L3 = 0;
    for (int i = 0; i < 7; i++)
    {
...
double getL4(struct triple *data, double julianEphemerisMillenium)
{
    double L4 = 0;
    for (int i = 0; i < 3; i++)
    {
...
double getL5(struct triple *data, double julianEphemerisMillenium)
{
    double L5 = 0;
    for (int i = 0; i < 1; i++)
    {
...
struct triple *initB0()
{
    static struct triple data[5] = {
        {280, 3.199, 84334.662},
        {102, 5.422, 5507.553},
        {80, 3.88, 5223.69},
        {44, 3.7, 2352.87},
...
struct triple *initB1()
{
    static struct triple data[2] = {
        {9, 3.9, 5507.55},
        {6, 1.73, 5223.69}
    };
...
double getB0(struct triple *data, double julianEphemerisMillenium)
{
    double B0 = 0;
    for (int i = 0; i < 5; i++)
    {
...
double getB1(struct triple *data, double julianEphemerisMillenium)
{
    double B1 = 0;
    for (int i = 0; i < 2; i++)
    {
...
struct triple *initR0()
{
    static struct triple data[40] = {
        {100013989, 0, 0},
...
struct triple *initR1()
{
    static struct triple data[10] = {
...
struct triple *initR2()
{
    static struct triple data[6] = {
...
double getR0(struct triple *data, double julianEphemerisMillenium)
{
    double R0 = 0;
    for (int i = 0; i < 40; i++)
    {
...
double getR1(struct triple *data, double julianEphemerisMillenium)
{
    double R1 = 0;
    for (int i = 0; i < 10; i++)
    {
...
double getR2(struct triple *data, double julianEphemerisMillenium)
{
    double R2 = 0;
    for (int i = 0; i < 6; i++)
    {
...
double getR3(struct triple *data, double julianEphemerisMillenium)
{
    double R3 = 0;
    for (int i = 0; i < 2; i++)
    {
...
double getR4(struct triple *data, double julianEphemerisMillenium)
{
    double R4 = 0;
    for (int i = 0; i < 1; i++)
    {
...
double *caller(int day, int year, int month, float hour, float min, float sec, float zone, float latitude, float longitude)
{
    ...
    */
    ...
    struct triple *dataL0 = initL0();
    struct triple *dataL1 = initL1();
    struct triple *dataL2 = initL2();
    struct triple *dataL3 = initL3();
    struct triple *dataL4 = initL4();
    struct triple *dataL5 = initL5();
    ...
    struct triple *dataB0 = initB0();
    struct triple *dataB1 = initB1();
    ...
    struct triple *dataR0 = initR0();
    struct triple *dataR1 = initR1();
    struct triple *dataR2 = initR2();
    struct triple *dataR3 = initR3();
    struct triple *dataR4 = initR4();
